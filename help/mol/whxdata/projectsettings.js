...
rh = window.rh;
model = rh.model;
var defaultTopic = "about-cp-dss-user-guide.htm";
...
rh.consts('HELP_ID', 'bfd49fa0-90a6-4859-8207-96d983c18414' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "User Guide");
