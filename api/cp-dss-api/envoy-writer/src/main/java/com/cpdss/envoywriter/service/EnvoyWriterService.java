...
import com.cpdss.common.generated.EnvoyWriter.WriterLoadableStudyRequest;
...
public class EnvoyWriterService {
  ...
  public WriterReply passDataToCommunicationServer(WriterLoadableStudyRequest request, Builder builder) {
