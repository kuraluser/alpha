...
public class LoadingPlanController {
	...
	@Autowired
	LoadingPlanServiceImpl loadingPlanServiceImpl;
	@Autowired
	...
	@Autowired
	GenerateLoadingPlanExcelReportService generateLoadingPlanExcelReportService;
	...
	public Object getPortRotationDetails(@RequestHeader HttpHeaders headers,
	 ...
	 *
	 * <p>
	 * Some data collect from Loadable study service and others in Loading plan DB
	 *
	 * @param vesselId       Long
	 * @param infoId         Long
	 * @param voyageId       Long
	...
	public LoadingInformation getLoadingInformation(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
		...
		try {
			...
			LoadingInformation var1 = this.loadingPlanService.getLoadingInformationByPortRotation(vesselId, infoId,
					portRotationId);
			return var1;
		} catch (GenericServiceException e) {
			e.printStackTrace();
	...
	public LoadingInformationResponse saveLoadingInformation(@RequestBody @Valid LoadingInformationRequest request,
		...
		try {
			...
			return this.loadingPlanService.saveLoadingInformation(request, headers.getFirst(CORRELATION_ID_HEADER));
		} catch (GenericServiceException e) {
	...
	@PostMapping("/vessels/{vesselId}/voyages/{voyageId}/loading-info/{infoId}/update-ullage/{portRotationId}")
	public UpdateUllage updateUllage(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody UpdateUllage updateUllageRequest) throws CommonRestException {
		try {
			return loadingInformationService.processUpdateUllage(vesselId, voyageId, infoId, portRotationId,
					updateUllageRequest, "");
		} catch (GenericServiceException e) {
	...
	public LoadingInfoAlgoResponse loadingInfoStatus(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
		...
		try {
			...
			return loadingPlanServiceImpl.saveLoadingInfoStatus(request, headers.getFirst(CORRELATION_ID_HEADER));
		} catch (GenericServiceException e) {
	...
	public LoadingInfoAlgoResponse generateLoadingPlan(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId)
			throws CommonRestException {
	...
	public RuleResponse getLoadingPlanRules(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId)
			throws CommonRestException {
	...
	public RuleResponse saveLoadingPlanRule(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@RequestBody RuleRequest loadingPlanRule) throws CommonRestException {
		try {
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping("/new-instruction/vessels/{vesselId}/loading-info/{infoId}/port-rotation/{portRotationId}")
	public LoadingInstructionsSaveResponse addLoadingInstructions(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody LoadingInstructionsSaveRequest request) throws CommonRestException {
		try {
			log.info("Adding new Loading instruction");
			return loadingInstructionService.addLoadingInstruction(vesselId, infoId, portRotationId, request);
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping("/update-instruction/vessels/{vesselId}/loading-info/{infoId}/port-rotation/{portRotationId}")
	public LoadingInstructionsSaveResponse updateLoadingInstructions(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody LoadingInstructionsUpdateRequest request) throws CommonRestException {
		try {
			log.info("Updating Loading instruction status for {}", vesselId);
			return loadingInstructionService.updateLoadingInstructions(vesselId, infoId, portRotationId, request);
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping("/delete-instruction/vessels/{vesselId}/loading-info/{infoId}/port-rotation/{portRotationId}")
	public LoadingInstructionsSaveResponse deleteLoadingInstructions(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody LoadingInstructionsStatus request) throws CommonRestException {
		try {
			log.info("Deleting Loading instruction , id{}", request.getInstructionId());
			return loadingInstructionService.deleteLoadingInstructions(vesselId, infoId, portRotationId, request);
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping("/edit-instruction/vessels/{vesselId}/loading-info/{infoId}/port-rotation/{portRotationId}")
	public LoadingInstructionsSaveResponse editLoadingInstructions(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody LoadingInstructionsStatus request) throws CommonRestException {
		try {
			...
			return loadingInstructionService.editLoadingInstructions(vesselId, infoId, portRotationId, request);
	...
	public LoadingInstructionResponse getAllLoadingInstructions(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId)
			throws CommonRestException {
	...
	public LoadingSequenceResponse getLoadingSequence(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId)
			throws CommonRestException {
		try {
			log.info("Get Loading Sequence api for vessel {}, voyage {}, loading information {}", vesselId, voyageId,
					infoId);
			return loadingPlanService.getLoadingSequence(vesselId, voyageId, infoId);
		} catch (GenericServiceException e) {
			log.error("Exception in Get Loading Sequence API");
			e.printStackTrace();
			throw new CommonRestException(CommonErrorCodes.E_HTTP_BAD_REQUEST, headers, HttpStatusCode.BAD_REQUEST,
					e.getMessage(), e);
		} catch (Exception e) {
			log.error("Exception in Get Loading Sequence API");
			e.printStackTrace();
	...
	public LoadingPlanAlgoResponse saveLoadingPlan(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@RequestBody LoadingPlanAlgoRequest loadingPlanAlgoRequest) throws CommonRestException {
		try {
			log.info("Save Loading Plan API for vessel {}, voyage {}, loading information {}", vesselId, voyageId,
					infoId);
	 ...
	 * @throws CommonRestException
	 */
	@GetMapping("/vessels/{vesselId}/voyages/{voyageId}/loading-info/{infoId}/loading-plan/{portRotationId}")
	public LoadingPlanResponse getLoadingPlan(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId)
			throws CommonRestException {
		try {
			log.info("Get Loading Plan API for vessel {}, voyage {}, loading information {}", vesselId, voyageId,
					infoId);
	 ...
	 * @throws CommonRestException
	 */
	@GetMapping("/vessels/{vesselId}/pattern/{patternId}/port/{portRotationId}/update-ullage/{operationType}")
	public LoadingUpdateUllageResponse getUpdateUllageDetails(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long patternId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@PathVariable String operationType) throws CommonRestException {
		try {
			log.info("Getting all update ullage details of vesselID: {} of pattern: {} with port rotation id: {}",
					vesselId, patternId, portRotationId);
			LoadingUpdateUllageResponse response = loadingPlanService.getUpdateUllageDetails(vesselId, patternId,
					portRotationId, operationType, false);
			return response;
		} catch (GenericServiceException e) {
	...
	public LoadingInfoAlgoStatus getLoadingInfoStatus(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@RequestBody LoadingInfoAlgoStatusRequest request) throws CommonRestException {
		try {
			log.info("Get Loading Information Status of" + " vessel {}, voyage {}, loading information {}", vesselId,
					voyageId, infoId);
			return loadingInformationService.getLoadingInfoAlgoStatus(vesselId, voyageId, infoId,
					request.getProcessId(), request.getConditionType());
		} catch (GenericServiceException e) {
			log.error("Exception in Get Loading Sequence API");
			e.printStackTrace();
			throw new CommonRestException(CommonErrorCodes.E_HTTP_BAD_REQUEST, headers, HttpStatusCode.BAD_REQUEST,
	 ...
	 */
	@GetMapping(value = "/vessels/{vesselId}/voyages/{voyageId}/loading-info/{infoId}/algo-errors/{conditionType}")
	public AlgoErrorResponse getAlgoErrors(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long voyageId,
			@PathVariable @Min(value = 0, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long infoId,
			@PathVariable(required = false) Integer conditionType) throws CommonRestException {
		try {
			log.info("Get Loading Information ALGO Errors Status for " + "vessel {}, voyage {}, loading information {}",
					vesselId, voyageId, infoId);
			return loadingInformationService.getLoadingInfoAlgoErrors(vesselId, voyageId, infoId, conditionType);
		} catch (GenericServiceException e) {
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping(value = "/loading/ullage-bill-update", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public UllageBillReply saveRulesForLoadableStudy(@RequestHeader HttpHeaders headers,
			@RequestBody UllageBillRequest inputData) throws CommonRestException {
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping(value = "/loading/{loadingId}/upload/port-tide-details", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public UploadTideDetailResponse uploadTideDetails(
			...
			@RequestHeader HttpHeaders headers, @RequestParam(name = "file", required = true) MultipartFile file,
			@RequestParam(name = "portName", required = true) String portName,
			@RequestParam(name = "portId", required = true) Long portId) throws CommonRestException {
		try {
			log.debug("inside controller");
			return loadingPlanService.uploadLoadingTideDetails(loadingId, file, headers.getFirst(CORRELATION_ID_HEADER),
					portName, portId);
	 ...
	 */
	@GetMapping(value = "/loading/download/port-tide-template", produces = MediaType.APPLICATION_JSON_VALUE)
	public HttpEntity<ByteArrayResource> getLoadablePlanReport(@RequestHeader HttpHeaders headers,
			@RequestParam(required = false, defaultValue = "0") Long loadingId) throws CommonRestException {

		try {
			log.debug("inside controller");
			HttpHeaders header = new HttpHeaders();
			header.setContentType(new MediaType("application", "force-download"));
			header.set(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + LOADING_PORT_TIDE_DETAIL_FILE_NAME);
			return new HttpEntity<>(new ByteArrayResource(loadingPlanService.downloadLoadingPortTideDetails(loadingId)),
					header);
		} catch (GenericServiceException e) {
	 ...
	 * @throws CommonRestException
	 */
	@PostMapping(value = "/vessels/{vesselId}/voyages/{voyageId}/loading-info/{infoId}/port-rotation/{portRotationId}/report", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public HttpEntity<ByteArrayResource> getLoadingReport(@RequestHeader HttpHeaders headers,
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long vesselId,
			...
			@PathVariable @Min(value = 1, message = CommonErrorCodes.E_HTTP_BAD_REQUEST) Long portRotationId,
			@RequestBody(required = false) LoadingPlanResponse requestPayload) throws CommonRestException {
		...
		try {
			...
			// Send file
			return new HttpEntity<ByteArrayResource>(new ByteArrayResource(generateLoadingPlanExcelReportService
					.generateLoadingPlanExcel(requestPayload, vesselId, voyageId, infoId, portRotationId, true)),
					header);
		} catch (GenericServiceException e) {
