      ...
      cowPlan.getCargoCow().stream()
          .forEach(
              cargo -> {
                ...
                cargoCow.setCargoNominationId(cargo.getCargoNominationId()==null?0:cargo.getCargoNominationId());
                cargoCow.setWashingCargoId(cargo.getWashingCargoId()==null?0:cargo.getWashingCargoId());
                cargoCow.setWashingCargoNominationId(cargo.getWashingCargoNominationId()==null?0:cargo.getWashingCargoNominationId());
