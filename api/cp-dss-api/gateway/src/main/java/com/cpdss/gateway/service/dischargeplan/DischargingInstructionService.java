...
public class DischargingInstructionService {
	  ...
	  public DischargingInstructionsSaveResponse addDischargingInstruction(
		    ...
		    try {
		      ...
		      ResponseStatus grpcResponse =
		          this.dischargingInstructionServiceBlockingStub.addDischargingInstruction(requestBuilder.build());
	  ...
	  public DischargingInstructionsSaveResponse updateDischargingInstructions(
		    ...
		    try {
		      ...
		      DischargingInstructionsUpdate.Builder requestBuilder = DischargingInstructionsUpdate.newBuilder();
	  ...
	  public DischargingInstructionsSaveResponse editDischargingInstructions(
		    ...
		    try {
		      ...
		      DischargingInstructionStatus.Builder requestBuilder = DischargingInstructionStatus.newBuilder();
	  ...
	  public DischargingInstructionResponse getDischargingInstructions(
		    ...
		    try {
		      ...
		      DischargingInstructionRequest.Builder requestBuilder = DischargingInstructionRequest.newBuilder();
		      requestBuilder
		          .setDischargingInfoId(infoId)
		          .setPortRotationId(portRotationId)
		          .setVesselId(vesselId);
		      DischargingInstructionDetails grpcResponse =
		          dischargingInstructionServiceBlockingStub.getDischargingInstructions(requestBuilder.build());
	  ...
	  private DischargingInstructionResponse buildResponseModel(DischargingInstructionDetails grpcResponse) {
