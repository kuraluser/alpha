...
public class VesselInfoService extends CommonKeyValueStore<KeycloakUser> {
  ...
  public VesselDetailsResponse getVesselsDetails(
    ...
    vesselDetailsResponse.setVesselCowParameters(
        this.buildVesselCowParameters(vesselAlgoReply.getVesselCowParametersList()));
  ...
  private List<VesselCowParameters> buildVesselCowParameters(
      List<VesselInfo.VesselCowParameters> vcpList) {
