...
public class VesselInfoService {
	 ...
	 */
	public VesselDetailsResponse getVesselsDetails(Long vesselId, String correlationId) throws GenericServiceException {
	 ...
	 */
	private List<ShearingForce> createShearingForceResponse(VesselAlgoReply vesselAlgoReply, String correlationId) {
		List<ShearingForce> shearingForces = new ArrayList<ShearingForce>();
		vesselAlgoReply.getBMAndSF().getShearingForceList().forEach(shearingForce -> {
	 ...
	 */
	private List<BendingMoment> createBendingMomentResponse(VesselAlgoReply vesselAlgoReply, String correlationId) {
		List<BendingMoment> bendingMoments = new ArrayList<BendingMoment>();
		vesselAlgoReply.getBMAndSF().getBendingMomentList().forEach(bendingMoment -> {
