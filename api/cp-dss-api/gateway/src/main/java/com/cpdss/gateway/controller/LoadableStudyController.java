...
import static com.cpdss.gateway.common.GatewayConstants.LOADABLE_STUDY_SAVE_REQUEST;
  ...
  public CommonResponse confirmPlan(
    ...
    try {
      return this.loadableStudyService.confirmPlan(
          voyageId, loadablePatternId, headers.getFirst(CORRELATION_ID_HEADER), vesselId);
    } catch (GenericServiceException e) {
