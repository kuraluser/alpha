...
public class GenerateLoadingPlanExcelReportStyle implements AreaListener {
  ...
  public void afterTransformCell(CellRef srcCell, CellRef targetCell, Context context) {
    ...
    LoadingPlanExcelLoadingPlanDetails data =
        mapper.convertValue(dataMap, LoadingPlanExcelLoadingPlanDetails.class);
        ...
        if (tankFromFile != null) {
          if (tankFromFile.getColorCode() != null
            ...
            newCellStyle.setFillForegroundColor(
                new XSSFColor(
                        Color.decode(tankFromFile.getColorCode()), new DefaultIndexedColorMap())
                    .getIndex());
