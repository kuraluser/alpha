...
public class VesselInfoService extends VesselInfoServiceImplBase {
	...
	public void getVesselDetailsForAlgo(VesselAlgoRequest request, StreamObserver<VesselAlgoReply> responseObserver) {
		...
		try {
			...
			if (vessel == null) {
				...
				bendingMomentRepository.findByVessel(vessel).forEach(bendingMoment -> {
					BendingMoment.Builder bendingMomentBuilder = BendingMoment.newBuilder();
					bMAndSFBuilder.addBendingMoment(createBendingMoment(bendingMoment, bendingMomentBuilder));
				});

				shearingForceRepository.findByVessel(vessel).forEach(shearingForce -> {
					ShearingForce.Builder shearingForceBuilder = ShearingForce.newBuilder();
					bMAndSFBuilder.addShearingForce(createShearingForce(shearingForce, shearingForceBuilder));
				});
	 ...
	 */
	private ShearingForce createShearingForce(com.cpdss.vesselinfo.entity.ShearingForce shearingForce,
	 ...
	 */
	private BendingMoment createBendingMoment(com.cpdss.vesselinfo.entity.BendingMoment bendingMoment,
