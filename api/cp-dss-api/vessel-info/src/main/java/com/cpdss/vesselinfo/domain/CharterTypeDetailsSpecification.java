...
@Data
@AllArgsConstructor
public class CharterTypeDetailsSpecification implements Specification<ChartererType> {
  private FilterCriteria criteria;

  @Override
  public Predicate toPredicate(
      Root<ChartererType> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
