...
@Data
@AllArgsConstructor
public class CharterCompanyDetailsSpecification implements Specification<ChartererCompany> {
  private FilterCriteria criteria;

  @Override
  public Predicate toPredicate(
      Root<ChartererCompany> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
