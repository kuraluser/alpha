...
package com.cpdss.loadingplan.service.redis;
...
import com.cpdss.loadingplan.domain.PortInfo;
...
@Slf4j
@Service
public class PortRedisService extends CommonKeyValueStore<PortInfo> {
  ...
  public Map<Long, String> fetchAllIdAndName() {
    PortInfo redisData = this.getData(RedisConfigConstants.PORT_MASTER_KEY);
    if (redisData != null) {
  ...
  public void fetchDomainDataFromService() {
    ...
    this.storeData(RedisConfigConstants.PORT_MASTER_KEY, new PortInfo(portInfoDomains));
