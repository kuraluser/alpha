...
@NoArgsConstructor
@AllArgsConstructor
public class DischargeStudyRules extends EntityDoc {
  ...
  @OneToMany(fetch = FetchType.LAZY, mappedBy = "dischargeStudyRules", cascade = CascadeType.ALL)
  private List<DischargeStudyRuleInput> dischargeStudyRuleInputs;
