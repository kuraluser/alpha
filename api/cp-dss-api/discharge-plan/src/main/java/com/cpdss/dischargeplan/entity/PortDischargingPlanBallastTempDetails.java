...
@Entity
@Table(name = "port_discharging_plan_stowage_ballast_details_temp")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class PortDischargingPlanBallastTempDetails extends EntityDoc {

  private static final long serialVersionUID = 1L;

  @Column(name = "discharging_information_xid")
