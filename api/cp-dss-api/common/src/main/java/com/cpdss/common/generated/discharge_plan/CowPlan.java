 ...
 */
public  final class CowPlan extends
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 82: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              cowTankDetails_ = new java.util.ArrayList<com.cpdss.common.generated.discharge_plan.CowTankDetails>();
              mutable_bitField0_ |= 0x00000001;
            }
            cowTankDetails_.add(
                input.readMessage(com.cpdss.common.generated.discharge_plan.CowTankDetails.parser(), extensionRegistry));
            break;
          }
          case 88: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.cpdss.common.generated.discharge_plan.DischargePlanModels.internal_static_CowPlan_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.cpdss.common.generated.discharge_plan.DischargePlanModels.internal_static_CowPlan_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.cpdss.common.generated.discharge_plan.CowPlan.class, com.cpdss.common.generated.discharge_plan.CowPlan.Builder.class);
  }
   ...
   */
  public java.util.List<com.cpdss.common.generated.discharge_plan.CowTankDetails> getCowTankDetailsList() {
  ...
  public int getSerializedSize() {
    ...
    if (cowOptionType_ != com.cpdss.common.generated.Common.COW_OPTION_TYPE.EMPTY_COW_OPTION_TYPE.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(1, cowOptionType_);
    }
    if (!getCowTankPercentBytes().isEmpty()) {
    ...
    if (needFreshCrudeStorage_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(8, needFreshCrudeStorage_);
    }
    if (needFlushingOil_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(9, needFlushingOil_);
    }
    for (int i = 0; i < cowTankDetails_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(10, cowTankDetails_.get(i));
    }
    if (cowWithCargoEnable_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(11, cowWithCargoEnable_);
    }
    if (dischargingInfoId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(12, dischargingInfoId_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.cpdss.common.generated.discharge_plan.CowPlan other = (com.cpdss.common.generated.discharge_plan.CowPlan) obj;

    if (cowOptionType_ != other.cowOptionType_) return false;
    if (!getCowTankPercent()
        .equals(other.getCowTankPercent())) return false;
    if (!getCowStartTime()
        .equals(other.getCowStartTime())) return false;
    if (!getCowEndTime()
        .equals(other.getCowEndTime())) return false;
    if (!getEstCowDuration()
        .equals(other.getEstCowDuration())) return false;
    if (!getTrimCowMin()
        .equals(other.getTrimCowMin())) return false;
    if (!getTrimCowMax()
        .equals(other.getTrimCowMax())) return false;
    if (getNeedFreshCrudeStorage()
        != other.getNeedFreshCrudeStorage()) return false;
    if (getNeedFlushingOil()
        != other.getNeedFlushingOil()) return false;
    if (getCowWithCargoEnable()
        != other.getCowWithCargoEnable()) return false;
    if (!getCowTankDetailsList()
        .equals(other.getCowTankDetailsList())) return false;
  ...
  public static com.cpdss.common.generated.discharge_plan.CowPlan parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.cpdss.common.generated.discharge_plan.CowPlan parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.cpdss.common.generated.discharge_plan.CowPlan buildPartial() {
      com.cpdss.common.generated.discharge_plan.CowPlan result = new com.cpdss.common.generated.discharge_plan.CowPlan(this);
    ...
    public Builder mergeFrom(com.cpdss.common.generated.discharge_plan.CowPlan other) {
      if (other == com.cpdss.common.generated.discharge_plan.CowPlan.getDefaultInstance()) return this;
          ...
          if (cowTankDetailsBuilder_.isEmpty()) {
            ...
            cowTankDetailsBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getCowTankDetailsFieldBuilder() : null;
          } else {
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.cpdss.common.generated.discharge_plan.CowPlan) e.getUnfinishedMessage();
     ...
     * @return This builder for chaining.
     */
    public Builder setCowTankPercent(
     ...
     * @return This builder for chaining.
     */
    public Builder setCowTankPercentBytes(
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setCowStartTime(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setCowStartTimeBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setCowEndTimeBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setEstCowDuration(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder setEstCowDurationBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setTrimCowMinBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setTrimCowMaxBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
    ...
    private void ensureCowTankDetailsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        cowTankDetails_ = new java.util.ArrayList<com.cpdss.common.generated.discharge_plan.CowTankDetails>(cowTankDetails_);
     ...
     */
    public Builder setCowTankDetails(
        int index, com.cpdss.common.generated.discharge_plan.CowTankDetails.Builder builderForValue) {
      if (cowTankDetailsBuilder_ == null) {
        ensureCowTankDetailsIsMutable();
     ...
     * <code>repeated .CowTankDetails cowTankDetails = 10;</code>
     */
    public Builder addCowTankDetails(com.cpdss.common.generated.discharge_plan.CowTankDetails value) {
      if (cowTankDetailsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllCowTankDetails(
        java.lang.Iterable<? extends com.cpdss.common.generated.discharge_plan.CowTankDetails> values) {
      if (cowTankDetailsBuilder_ == null) {
        ensureCowTankDetailsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, cowTankDetails_);
        onChanged();
      } else {
    ...
    public com.cpdss.common.generated.discharge_plan.CowTankDetailsOrBuilder getCowTankDetailsOrBuilder(
        int index) {
      if (cowTankDetailsBuilder_ == null) {
        return cowTankDetails_.get(index);  } else {
     ...
     * <code>repeated .CowTankDetails cowTankDetails = 10;</code>
     */
    public com.cpdss.common.generated.discharge_plan.CowTankDetails.Builder addCowTankDetailsBuilder() {
      return getCowTankDetailsFieldBuilder().addBuilder(
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ...
        getCowTankDetailsFieldBuilder() {
      if (cowTankDetailsBuilder_ == null) {
        cowTankDetailsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.cpdss.common.generated.discharge_plan.CowTankDetails, com.cpdss.common.generated.discharge_plan.CowTankDetails.Builder, com.cpdss.common.generated.discharge_plan.CowTankDetailsOrBuilder>(
                cowTankDetails_,
  ...
  private static final com.google.protobuf.Parser<CowPlan>
      PARSER = new com.google.protobuf.AbstractParser<CowPlan>() {
    @java.lang.Override
