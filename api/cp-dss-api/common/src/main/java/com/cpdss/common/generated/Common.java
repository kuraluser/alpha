...
public final class Common {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public int getSerializedSize() {
      ...
      if (disableInSettigs_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, disableInSettigs_);
      }
      if (!getRuleTypeBytes().isEmpty()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getDisableInSettigs()
          != other.getDisableInSettigs()) return false;
      if (!getRuleType()
  ...
  static {
    ...
    internal_static_BillOfLadding_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BillOfLadding_descriptor,
        new java.lang.String[] { "Id", "PortId", "CargoId", "QuantityBbls", "QuantityMt", "QuantityKl", "Api", "Temperature", });
    internal_static_RulePlans_descriptor =
    ...
    internal_static_Rules_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Rules_descriptor,
        new java.lang.String[] { "Id", "Enable", "Disable", "DisableInSettigs", "RuleType", "Inputs", "RuleTemplateId", "VesselRuleXId", });
    internal_static_RulesInputs_descriptor =
