...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (washingCargoId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(3, washingCargoId_);
    }
    if (washingCargoNominationId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(4, washingCargoNominationId_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < tankIds_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getWashingCargoId()
        != other.getWashingCargoId()) return false;
    if (getWashingCargoNominationId()
        != other.getWashingCargoNominationId()) return false;
    if (!getTankIdsList()
