...
public interface DischargingInfoLoadicatorDataRequestOrBuilder extends
   ...
   */
  java.util.List<com.cpdss.common.generated.loading_plan.LoadingPlanModels.LoadingInfoLoadicatorDetail> 
      getLoadingInfoLoadicatorDetailsList();
  /**
   * <code>repeated .LoadingInfoLoadicatorDetail loadingInfoLoadicatorDetails = 3;</code>
   */
  com.cpdss.common.generated.loading_plan.LoadingPlanModels.LoadingInfoLoadicatorDetail getLoadingInfoLoadicatorDetails(int index);
  /**
   * <code>repeated .LoadingInfoLoadicatorDetail loadingInfoLoadicatorDetails = 3;</code>
   */
   ...
   * <code>repeated .LoadingInfoLoadicatorDetail loadingInfoLoadicatorDetails = 3;</code>
   */
  java.util.List<? extends com.cpdss.common.generated.loading_plan.LoadingPlanModels.LoadingInfoLoadicatorDetailOrBuilder> 
      getLoadingInfoLoadicatorDetailsOrBuilderList();
  /**
   * <code>repeated .LoadingInfoLoadicatorDetail loadingInfoLoadicatorDetails = 3;</code>
   */
  com.cpdss.common.generated.loading_plan.LoadingPlanModels.LoadingInfoLoadicatorDetailOrBuilder getLoadingInfoLoadicatorDetailsOrBuilder(
      int index);
