...
public final class LoadableStudy {
  ...
  public static final class PortRotationDetail extends com.google.protobuf.GeneratedMessageV3
    ...
    public static final int BIRTHID_FIELD_NUMBER = 3;
    private long birthId_;
    /**
     * <code>int64 birthId = 3;</code>
     *
     * @return The birthId.
    ...
    public int getSerializedSize() {
      ...
      if (birthId_ != 0L) {
        size += com.google.protobuf.CodedOutputStream.computeInt64Size(3, birthId_);
      }
      if (operationId_ != 0L) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getId() != other.getId()) return false;
      if (getPortId() != other.getPortId()) return false;
      if (getBirthId() != other.getBirthId()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + PORTID_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(getPortId());
      hash = (37 * hash) + BIRTHID_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(getBirthId());
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(com.cpdss.common.generated.LoadableStudy.PortRotationDetail other) {
        ...
        if (other.getBirthId() != 0L) {
          setBirthId(other.getBirthId());
        }
       ...
       * <code>int64 birthId = 3;</code>
       *
       * @param value The birthId to set.
       * @return This builder for chaining.
       */
      public Builder setBirthId(long value) {
  ...
  static {
    ...
    internal_static_ValveSegregationReply_fieldAccessorTable = new
      ...
      "\n\024loadable_study.proto\032\014common.proto\"q\n\r"
          ...
          + "\001(\0132\026.CargoNominationDetail\"Z\n\024CargoNomi"
          + "nationReply\022\'\n\016responseStatus\030\001 \001(\0132\017.Re"
          + "sponseStatus\022\031\n\021cargoNominationId\030\002 \001(\003\""
          + "R\n\023PortRotationRequest\022\027\n\017loadableStudyI"
          + "d\030\001 \001(\003\022\020\n\010vesselId\030\002 \001(\003\022\020\n\010voyageId\030\003 "
          + "\001(\003\"\241\002\n\022PortRotationDetail\022\n\n\002id\030\001 \001(\003\022\016"
          + "\n\006portId\030\002 \001(\003\022\017\n\007birthId\030\003 \001(\003\022\023\n\013opera"
          + "tionId\030\004 \001(\003\022\027\n\017seaWaterDensity\030\005 \001(\t\022\034\n"
          + "\024distanceBetweenPorts\030\006 \001(\t\022\022\n\ntimeOfSta"
          + "y\030\007 \001(\t\022\020\n\010maxDraft\030\010 \001(\t\022\023\n\013maxAirDraft"
          + "\030\t \001(\t\022\013\n\003eta\030\n \001(\t\022\013\n\003etd\030\013 \001(\t\022\022\n\nlayC"
          + "anFrom\030\014 \001(\t\022\020\n\010layCanTo\030\r \001(\t\022\027\n\017loadab"
          + "leStudyId\030\016 \001(\003\".\n\tOperation\022\n\n\002id\030\001 \001(\003"
          + "\022\025\n\roperationName\030\002 \001(\t\"}\n\021PortRotationR"
          + "eply\022$\n\016responseStatus\030\001 \001(\0132\014.StatusRep"
          + "ly\022\"\n\005ports\030\002 \003(\0132\023.PortRotationDetail\022\036"
          + "\n\noperations\030\003 \003(\0132\n.Operation\"{\n\030Loadab"
          + "leQuantityResponse\0229\n\027loadableQuantityRe"
          + "quest\030\001 \001(\0132\030.LoadableQuantityRequest\022$\n"
          + "\016responseStatus\030\002 \001(\0132\014.StatusReply2\303\004\n\024"
          + "LoadableStudyService\022,\n\nSaveVoyage\022\016.Voy"
          + "ageRequest\032\014.VoyageReply\"\000\0228\n\022GetVoyages"
          + "ByVessel\022\016.VoyageRequest\032\020.VoyageListRep"
          + "ly\"\000\022J\n\024SaveLoadableQuantity\022\030.LoadableQ"
          + "uantityRequest\032\026.LoadableQuantityReply\"\000"
          + "\022T\n$FindLoadableStudiesByVesselAndVoyage"
          + "\022\025.LoadableStudyRequest\032\023.LoadableStudyR"
          + "eply\"\000\022@\n\021SaveLoadableStudy\022\024.LoadableSt"
          + "udyDetail\032\023.LoadableStudyReply\"\000\022G\n\023Save"
          + "CargoNomination\022\027.CargoNominationRequest"
          + "\032\025.CargoNominationReply\"\000\022J\n\034GetLoadable"
          + "StudyPortRotation\022\024.PortRotationRequest\032"
          + "\022.PortRotationReply\"\000\022J\n\023getLoadableQuan"
          + "tity\022\026.LoadableQuantityReply\032\031.LoadableQ"
          + "uantityResponse\"\000B\036\n\032com.cpdss.common.ge"
    ...
    internal_static_PortRotationReply_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
            internal_static_PortRotationReply_descriptor,
            new java.lang.String[] {
              "ResponseStatus", "Ports", "Operations",
            });
