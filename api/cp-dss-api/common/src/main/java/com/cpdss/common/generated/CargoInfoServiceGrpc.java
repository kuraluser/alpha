...
public final class CargoInfoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoRequest,
      com.cpdss.common.generated.CargoInfo.CargoDetailReply> getGetCargoInfoByIdMethod;
  ...
  public static io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoRequest,
      com.cpdss.common.generated.CargoInfo.CargoDetailReply> getGetCargoInfoByIdMethod() {
    io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoRequest, com.cpdss.common.generated.CargoInfo.CargoDetailReply> getGetCargoInfoByIdMethod;
    if ((getGetCargoInfoByIdMethod = CargoInfoServiceGrpc.getGetCargoInfoByIdMethod) == null) {
      synchronized (CargoInfoServiceGrpc.class) {
        if ((getGetCargoInfoByIdMethod = CargoInfoServiceGrpc.getGetCargoInfoByIdMethod) == null) {
          CargoInfoServiceGrpc.getGetCargoInfoByIdMethod = getGetCargoInfoByIdMethod =
              io.grpc.MethodDescriptor.<com.cpdss.common.generated.CargoInfo.CargoRequest, com.cpdss.common.generated.CargoInfo.CargoDetailReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cpdss.common.generated.CargoInfo.CargoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cpdss.common.generated.CargoInfo.CargoDetailReply.getDefaultInstance()))
              .setSchemaDescriptor(new CargoInfoServiceMethodDescriptorSupplier("GetCargoInfoById"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoListRequest,
      com.cpdss.common.generated.CargoInfo.CargoReply> getGetCargoInfosByCargoIdsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.cpdss.common.generated.CargoInfo.CargoReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoListRequest,
      com.cpdss.common.generated.CargoInfo.CargoReply> getGetCargoInfosByCargoIdsMethod() {
    io.grpc.MethodDescriptor<com.cpdss.common.generated.CargoInfo.CargoListRequest, com.cpdss.common.generated.CargoInfo.CargoReply> getGetCargoInfosByCargoIdsMethod;
    if ((getGetCargoInfosByCargoIdsMethod = CargoInfoServiceGrpc.getGetCargoInfosByCargoIdsMethod) == null) {
      synchronized (CargoInfoServiceGrpc.class) {
        if ((getGetCargoInfosByCargoIdsMethod = CargoInfoServiceGrpc.getGetCargoInfosByCargoIdsMethod) == null) {
          CargoInfoServiceGrpc.getGetCargoInfosByCargoIdsMethod = getGetCargoInfosByCargoIdsMethod =
              io.grpc.MethodDescriptor.<com.cpdss.common.generated.CargoInfo.CargoListRequest, com.cpdss.common.generated.CargoInfo.CargoReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCargoInfosByCargoIds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cpdss.common.generated.CargoInfo.CargoListRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cpdss.common.generated.CargoInfo.CargoReply.getDefaultInstance()))
              .setSchemaDescriptor(new CargoInfoServiceMethodDescriptorSupplier("GetCargoInfosByCargoIds"))
              .build();
        }
      }
    }
  ...
  public static abstract class CargoInfoServiceImplBase implements io.grpc.BindableService {
    ...
    public void getCargoInfo(com.cpdss.common.generated.CargoInfo.CargoRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCargoInfoMethod(), responseObserver);
    }
    ...
    public void getCargoInfoByPaging(com.cpdss.common.generated.CargoInfo.CargoRequestWithPaging request,
        io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCargoInfoByPagingMethod(), responseObserver);
    }

    /**
     */
    public void getCargoInfoById(com.cpdss.common.generated.CargoInfo.CargoRequest request,
        io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoDetailReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCargoInfoByIdMethod(), responseObserver);
    }

    /**
     */
    public void getCargoInfosByCargoIds(com.cpdss.common.generated.CargoInfo.CargoListRequest request,
        io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCargoInfosByCargoIdsMethod(), responseObserver);
    }
  ...
  public static final class CargoInfoServiceStub extends io.grpc.stub.AbstractAsyncStub<CargoInfoServiceStub> {
    ...
    public void getCargoInfoById(com.cpdss.common.generated.CargoInfo.CargoRequest request,
        io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoDetailReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetCargoInfoByIdMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getCargoInfosByCargoIds(com.cpdss.common.generated.CargoInfo.CargoListRequest request,
        io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetCargoInfosByCargoIdsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CargoInfoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CargoInfoServiceBlockingStub> {
    ...
    /**
     */
    public com.cpdss.common.generated.CargoInfo.CargoDetailReply getCargoInfoById(com.cpdss.common.generated.CargoInfo.CargoRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.cpdss.common.generated.CargoInfo.CargoReply getCargoInfosByCargoIds(com.cpdss.common.generated.CargoInfo.CargoListRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CargoInfoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CargoInfoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cpdss.common.generated.CargoInfo.CargoDetailReply> getCargoInfoById(
        com.cpdss.common.generated.CargoInfo.CargoRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cpdss.common.generated.CargoInfo.CargoReply> getCargoInfosByCargoIds(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_CARGO_INFO_BY_ID:
          serviceImpl.getCargoInfoById((com.cpdss.common.generated.CargoInfo.CargoRequest) request,
              (io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoDetailReply>) responseObserver);
          break;
        case METHODID_GET_CARGO_INFOS_BY_CARGO_IDS:
          serviceImpl.getCargoInfosByCargoIds((com.cpdss.common.generated.CargoInfo.CargoListRequest) request,
              (io.grpc.stub.StreamObserver<com.cpdss.common.generated.CargoInfo.CargoReply>) responseObserver);
          break;
        default:
