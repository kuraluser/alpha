...
public class LoadicatorService {
  ...
  public LoadableStudy.LoadicatorDataReply.Builder getLoadicatorData(LoadableStudy.LoadicatorDataRequest request, LoadableStudy.LoadicatorDataReply.Builder replyBuilder) throws Exception {
  ...
  private void saveLoadicatorAlgoRequest(
          LoadableStudy.LoadicatorDataRequest request, LoadicatorAlgoRequest loadicator, ObjectMapper objectMapper) {
  ...
  private void saveLoadicatorAlgoResponse(
          LoadableStudy.LoadicatorDataRequest request, LoadicatorAlgoResponse response, ObjectMapper objectMapper) {
