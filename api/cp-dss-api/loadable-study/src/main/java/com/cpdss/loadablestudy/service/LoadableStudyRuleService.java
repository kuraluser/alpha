...
public class LoadableStudyRuleService {
    ...
    List<LoadableStudyRules> getLoadableStudyRules(com.cpdss.common.generated.LoadableStudy.LoadableStudyDetail request) throws GenericServiceException {
        ...
        VesselInfo.VesselRuleRequest.Builder vesselRuleBuilder = VesselInfo.VesselRuleRequest.newBuilder();
    ...
    private void updateDisplayInSettingsInLoadableStudyRules(VesselInfo.VesselRuleReply vesselRuleReply) {
    ...
    void saveDuplicateLoadableStudyRules(List<LoadableStudyRules> listOfExistingLSRules, LoadableStudy currentLoableStudy, com.cpdss.common.generated.LoadableStudy.LoadableStudyDetail request){
    ...
    public void getOrSaveRulesForLoadableStudy(com.cpdss.common.generated.LoadableStudy.LoadableRuleRequest request, com.cpdss.common.generated.LoadableStudy.LoadableRuleReply.Builder builder) throws GenericServiceException {
        ...
        for (int ruleIndex = 0; ruleIndex < lStudyRulesList.size(); ruleIndex++) {
            ...
            for (int inputIndex = 0;
                ...
                if (lStudyRulesList
                    ...
                    Common.RuleDropDownMaster.Builder ruleDropDownMaster = Common.RuleDropDownMaster.newBuilder();
                    if (lStudyRulesList
                            .get(ruleIndex)
                            .getLoadableStudyRuleInputs()
                            .get(inputIndex)
