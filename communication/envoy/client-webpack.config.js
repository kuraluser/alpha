...
function generatePackageJson() {
  ...
  //required only for windows packaging. can be removed on actual deployment
  const pkg = packageJson.pkg;
  //-----------------including bin and name keys from basePackageJson
  const basePackageJson = {
    dependencies, pkg, "bin": "main.js", "name": "envoy-client"
  };
