...
export class AddBerthComponent implements OnInit {
  ...
  initBethsFormGroup(berths: IBerthValueObject) {
    return this.fb.group({
      ...
      maxLoa: this.fb.control(berths?.maxLoa?.value, [Validators.required, Validators.max(500), numberValidator(2, 3, false)]),
      maxDwt: this.fb.control(berths?.maxDwt?.value, [Validators.required, Validators.max(500000), numberValidator(2, 6, false)]),
