...
export class LoadingApiService {
   ...
   * @memberof LoadingApiService
   */
  getAlgoErrorDetails(vesselId: number, voyageId: number, loadingInfoId: number): Observable<IAlgoResponse> {
    return this.commonApiService.get<IAlgoResponse>(`vessels/${vesselId}/voyages/${voyageId}/loading-info/${loadingInfoId}/algo-errors`);
  }
}
